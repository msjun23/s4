...
class SequenceModel(SequenceModule):
    ...
    def __init__(
        ...
        # self.masking_net = ImageMaskingNet(dim=d_model, mode='m', height=32, width=32)
    ...
    def forward(self, inputs, *args, state=None, **kwargs):
        ...
        # vis.save_BLD_path_as_33grid_image(outputs, 0, f'BiSpkEnc_wo_norm/BiSpkEnc_S4_embed_output_{self.b_idx}.png')
        # self.b_idx += 1
